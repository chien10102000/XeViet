        ...
        public void onClick(View v) {
            ...
            switch (position){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    AlertDialog.Builder alertDieuKhoan=new AlertDialog.Builder(v.getContext());
                    alertDieuKhoan.setTitle("Điều khoản");
                    alertDieuKhoan.setMessage("1. Không đăng linh tinh\n2. Bán được rồi thì xóa\n3. Không được đánh cãi chửi nhau");
                    alertDieuKhoan.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.cancel();
                        }
                    });
                    AlertDialog alDK=alertDieuKhoan.create();
                    alDK.show();
                    break;
                default:
